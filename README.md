...
| `@claude-bot status` | Reply with the current state (`status`, `started_at`, `last_event_at`, full `session_id`) plus a copy-paste `claude --resume <id>` command so you can take the session over in your terminal. |
